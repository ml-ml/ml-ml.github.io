# Backup of the previous inline CV content (not published).
# The live /cv/ page now serves files/LIMA_CV.pdf only.
...
Work Experience
======
* **Alibaba Group**, Beijing, China, 05/2022 - 01/2023
  * Research Intern in Advertisement Recommendation Team
  * Designed a temporal graph-based model to predict user follow behavior in live-stream platforms
  * Collaborated on developing a multi-level curriculum learning framework for live-stream recommendation

* **Ant Group**, Hangzhou, China, 04/2021 - 04/2022
  * Research Intern in Graph Platform Team
  * Conducted research on graph structure learning, focusing on task-guided topology refinement
  * Proposed a novel end-to-end graph structure learning framework

* **Puxin Hengye Technology Co., Ltd.**, Beijing, China, 07/2018 - 08/2019
...
* First Prize, Chinese Universities Aquatic Sports Open, 2023
* Third Prize, China Graduate Mathematical Contest in Modeling, 2020
